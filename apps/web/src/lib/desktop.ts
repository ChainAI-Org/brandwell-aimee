import type { AimeeDesktop, AimeeDesktopOAuthCallback } from "@rakazo/contracts";

export type { AimeeDesktop, AimeeDesktopOAuthCallback } from "@rakazo/contracts";

declare global {
  interface Window {
    rakazoDesktop?: AimeeDesktop;
  }
}

export function desktopBridge(): AimeeDesktop | undefined {
...
export function windowChromeKind(desktop?: AimeeDesktop): "spacer" | "darwin" | "controls" {
